package org.apache.struts2.customfile;
...
//import org.apache.struts2.customfile.Struts2FileManagerOnGAE;

/**
 * Custom implementation
 */
public class Struts2FileManagerFactoryOnGAE implements FileManagerFactory {

    private static final Logger LOG = LoggerFactory.getLogger(Struts2FileManagerFactoryOnGAE.class);
    ...
    {
		LOG.debug("Looking up file manager: #0");
	  
        Set<String> names = container.getInstanceNames(FileManager.class);
        
        if (LOG.isDebugEnabled()) 
        {
            LOG.debug("[MINE] Found following implementations of FileManager interface: #0", names.toString());
        }
